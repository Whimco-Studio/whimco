...
export default function HowItWorks() {
  ...
  return (
    <div className="spotlight-page" id="how-it-works">
      <style jsx global>{`
        .spotlight-page {
          --blurple: #5865F2;
          --blurple-dark: #4752C4;
      ...
      <div className={`scene closing ${currentScene === 9 ? 'active' : ''}`} id="scene10">
        ...
        <a className="cta-button" id="ctaButton" href={INVITE_URL} target="_blank" rel="noopener noreferrer">Add Spotlight to Discord</a>
      </div>
